 ...
 */
@Configuration
@MapperScan(basePackages = {"com.yxkong.demo.infrastructure.persistence.mapper.demoandx"}, sqlSessionFactoryRef = "sqlSessionFactoryDemoAndX")
public class DemoAndXDBConfiguration {

    @Resource(name = "demoDynamicDataSource")
     ...
     * @throws Exception
     */
    @Bean(name = "sqlSessionFactoryDemoAndX")
    public SqlSessionFactory sqlSessionFactoryDemoAndX() throws Exception {
        ...
        factoryBean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:mybatis/mapper/demoandx/*Mapper.xml"));
        return factoryBean.getObject();
    }

    @Bean(name = "sqlSessionTemplateDemoAndX")
    public SqlSessionTemplate sqlSessionTemplateDemoAndX() throws Exception {
        // 使用上面配置的Factory
        return new SqlSessionTemplate(sqlSessionFactoryDemoAndX());
    }
}
